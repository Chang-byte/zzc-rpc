 ...
 * @author Chang
 * @version 1.0
 * @title ConsistentHashLoadBalancerTest
 * @description 一致性哈希测试
 */
public class ConsistentHashLoadBalancerTest {
    ...
    public ConsistentHashLoadBalancerTest(List<String> servers, int virtualNodes) {
    ...
    public static void test_ring() {
        ...
        // 构建一致性哈希环
        ConsistentHashLoadBalancerTest demo = new ConsistentHashLoadBalancerTest(servers, 10);
    ...
    public static void t() {
        ...
        Map.Entry<Integer, String> integerStringEntry = ring.ceilingEntry(80);
